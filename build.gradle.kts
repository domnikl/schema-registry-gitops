...
dependencies {
    ...
    implementation("io.confluent:kafka-schema-registry-client:7.9.4")
    implementation("io.confluent:kafka-protobuf-serializer:7.9.4")
    implementation("io.confluent:kafka-json-schema-serializer:7.9.4")
